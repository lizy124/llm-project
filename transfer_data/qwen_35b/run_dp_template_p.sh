...
if [ "$#" -ne 7 ]; then
  ...
  echo "Example: $0 0,1 8000 4 0 141.61.81.162 12321 2"
  exit 1
fi
...
LOCAL_IP="${LOCAL_IP:-141.61.81.162}"
NIC_NAME="${NIC_NAME:-enp196s0f3}"
...
exec vllm serve /tmp/liaobiting/Qwen3.5-35B-A3B-w4a8-org \
  --quantization ascend \
