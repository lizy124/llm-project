...
: > "$TEST_LOG"
echo "RUNNING: DSV4-Flash PDMix layerwise KV Pool validation" | tee "$STATUS_FILE"
...
pass_msg "DSV4-Flash PDMix layerwise KV Pool smoke and repeated-prefix validation passed"
