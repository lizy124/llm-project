...
modules = [
    ...
    'vllm_ascend.distributed.kv_transfer.kv_pool.ascend_store.attention_fence',
    'vllm_ascend.distributed.kv_transfer.kv_pool.ascend_store.metadata',
    ...
    'vllm_ascend.distributed.kv_transfer.kv_pool.ascend_store.backend.base',
]
...
PY
  then
    ...
    python3 -m pytest tests/ut/distributed/mooncake/test_mooncake_kv_transfer.py -q
  else
