...
PORT="${PORT:-8100}"
DEVICE="${ASCEND_RT_VISIBLE_DEVICES:-4}"
LOG="${RUN_DIR}/server_pd_prefill.log"
...
PID=$!
write_pid "${RUN_DIR}" server_pd_prefill "${PID}"
printf '%s\n' "${KV_TRANSFER_CONFIG}" > "${RUN_DIR}/kv_transfer_config_pd_prefill.json"
