...
: > "$TEST_LOG"
echo "RUNNING: GLM-5.2 W4A8 PDMix non-layerwise KV Pool validation" | tee "$STATUS_FILE"
...
shared_prefix = (
    "You are validating KV cache pool reuse for GLM-5.2. "
...
pass_msg "GLM-5.2 W4A8 PDMix non-layerwise KV Pool smoke and repeated-prefix validation passed"
