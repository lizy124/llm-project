...
- `tmp_doc/structure_analysis/vllm_entrypoints_api_layer`：API 层、OpenAI Server、请求入口。
- `tmp_doc/structure_analysis/vllm_inference_engine_layer`：EngineCore、Scheduler、请求生命周期。
- `tmp_doc/structure_analysis/vllm_scheduler_kv_cache`：调度、KV Cache、Prefix Cache、KV Connector。
- `tmp_doc/structure_analysis/vllm_worker_executor_layer`：Executor、Worker、ModelRunner。
- `tmp_doc/structure_analysis/vllm_model_executor_attention_layer`：模型执行、Attention、KV Tensor、Slot Mapping。
- `tmp_doc/structure_analysis/vllm_native_acceleration_layer`：CUDA / C++ / CUTLASS / Marlin / Machete / MoE kernel。
- `tmp_doc/structure_analysis/vllm_distributed_communication`：TP/PP/DP/EP、ProcessGroup、Collective、Runtime flow。
- `tmp_doc/documents/pool`：KV Cache 池化、复用、存储、ChunkedTokenDatabase。
- `tmp_doc/documents/distributed_DP`：PD 分离、Prefill/Decode 解耦、KV Transfer、Layerwise Push。
...
3. vLLM 核心架构
   ...
   - `llm-project/tmp_doc/structure_analysis/vllm_inference_engine_layer` 是主参考。
...
5. KV Cache 与 PagedAttention
   ...
   - `llm-project/tmp_doc/structure_analysis/vllm_scheduler_kv_cache` 和 `tmp_doc/documents/pool` 是主参考。
...
2. 分布式推理
   ...
   - `llm-project/tmp_doc/structure_analysis/vllm_distributed_communication` 是主参考。
...
3. Prefill/Decode 分离
   ...
   - `llm-project/tmp_doc/documents/distributed_DP` 是主参考。
...
- `tmp_doc/structure_analysis/vllm_entrypoints_api_layer/README.md`
- `tmp_doc/structure_analysis/vllm_entrypoints_api_layer/05_Chat与Completion请求链路.md`
- `tmp_doc/structure_analysis/vllm_entrypoints_api_layer/07_API层与Engine边界.md`
...
- `tmp_doc/structure_analysis/vllm_inference_engine_layer/01_推理引擎层总览.md`
- `tmp_doc/structure_analysis/vllm_inference_engine_layer/02_请求生命周期_API到EngineCore.md`
- `tmp_doc/structure_analysis/vllm_inference_engine_layer/03_EngineCore主循环与V0兼容.md`
...
- `tmp_doc/structure_analysis/vllm_inference_engine_layer/04_Scheduler调度机制.md`
- `tmp_doc/structure_analysis/vllm_scheduler_kv_cache/01_scheduler_overview.md`
- `tmp_doc/structure_analysis/vllm_scheduler_kv_cache/03_request_lifecycle.md`
...
- `tmp_doc/structure_analysis/vllm_inference_engine_layer/05_KVCache_Block_PrefixCaching.md`
- `tmp_doc/structure_analysis/vllm_scheduler_kv_cache/02_kv_cache_architecture.md`
- `tmp_doc/structure_analysis/vllm_model_executor_attention_layer/06_KVCacheSpec与KV_Tensor_SlotMapping.md`
- `tmp_doc/documents/pool/05_推理时存储KV_Cache.md`
- `tmp_doc/documents/pool/06_从池子复用KV_Cache.md`
- `tmp_doc/documents/pool/07_ChunkedTokenDatabase_键管理与地址计算.md`
...
- `tmp_doc/structure_analysis/vllm_worker_executor_layer/README.md`
- `tmp_doc/structure_analysis/vllm_worker_executor_layer/02_Executor抽象与后端选择.md`
- `tmp_doc/structure_analysis/vllm_worker_executor_layer/07_GPU_CPU_XPU_Worker生命周期.md`
- `tmp_doc/structure_analysis/vllm_worker_executor_layer/08_ModelRunner执行链路.md`
- `tmp_doc/structure_analysis/vllm_worker_executor_layer/11_端到端调用链路.md`
...
- `tmp_doc/structure_analysis/vllm_model_executor_attention_layer/README.md`
- `tmp_doc/structure_analysis/vllm_model_executor_attention_layer/04_Attention层核心实现.md`
- `tmp_doc/structure_analysis/vllm_model_executor_attention_layer/05_AttentionBackend选择与MetadataBuilder.md`
- `tmp_doc/structure_analysis/vllm_model_executor_attention_layer/08_CUDA_csrc_kernel调用链与调试地图.md`
- `tmp_doc/structure_analysis/vllm_native_acceleration_layer/04_CUDA核心算子_Attention与KVCache.md`
...
- `tmp_doc/structure_analysis/vllm_distributed_communication/00_README.md`
- `tmp_doc/structure_analysis/vllm_distributed_communication/02_parallel_config_and_topology.md`
- `tmp_doc/structure_analysis/vllm_distributed_communication/04_process_groups_and_collectives.md`
- `tmp_doc/structure_analysis/vllm_distributed_communication/05_runtime_parallel_flows.md`
- `tmp_doc/structure_analysis/vllm_worker_executor_layer/10_分布式并行与通信.md`
...
- `tmp_doc/documents/distributed_DP/README.md`
- `tmp_doc/documents/distributed_DP/01_总览_PD分离架构.md`
- `tmp_doc/documents/distributed_DP/05_Decode端拉取KV_Cache.md`
- `tmp_doc/documents/distributed_DP/06_Prefill端延迟释放与完成确认.md`
- `tmp_doc/documents/distributed_DP/08_Layerwise_Push模式.md`
...
- `tmp_doc/structure_analysis/vllm_model_executor_attention_layer/07_量化_MoE_LoRA_多模态.md`
- `tmp_doc/structure_analysis/vllm_native_acceleration_layer/05_量化_GEMM_CUTLASS_Marlin_Machete.md`
- `tmp_doc/structure_analysis/vllm_native_acceleration_layer/06_MoE底层算子.md`
- `tmp_doc/structure_analysis/vllm_worker_executor_layer/09_KVCache_LoRA_KVTransfer_Profiler.md`
...
1. `tmp_doc/structure_analysis/vllm_entrypoints_api_layer/README.md`
2. `tmp_doc/structure_analysis/vllm_inference_engine_layer/README.md`
3. `tmp_doc/structure_analysis/vllm_inference_engine_layer/02_请求生命周期_API到EngineCore.md`
4. `tmp_doc/structure_analysis/vllm_inference_engine_layer/04_Scheduler调度机制.md`
5. `tmp_doc/structure_analysis/vllm_inference_engine_layer/05_KVCache_Block_PrefixCaching.md`
6. `tmp_doc/structure_analysis/vllm_worker_executor_layer/08_ModelRunner执行链路.md`
7. `tmp_doc/structure_analysis/vllm_model_executor_attention_layer/04_Attention层核心实现.md`
8. `tmp_doc/structure_analysis/vllm_model_executor_attention_layer/08_CUDA_csrc_kernel调用链与调试地图.md`
9. `tmp_doc/structure_analysis/vllm_native_acceleration_layer/04_CUDA核心算子_Attention与KVCache.md`
10. `tmp_doc/structure_analysis/vllm_distributed_communication/00_README.md`

### KV Pool / PD 分离主线

1. `tmp_doc/documents/pool/01_总览_池化系统架构.md`
2. `tmp_doc/documents/pool/05_推理时存储KV_Cache.md`
3. `tmp_doc/documents/pool/06_从池子复用KV_Cache.md`
4. `tmp_doc/documents/pool/07_ChunkedTokenDatabase_键管理与地址计算.md`
5. `tmp_doc/documents/pool/08_全链路串联总结.md`
6. `tmp_doc/documents/distributed_DP/01_总览_PD分离架构.md`
7. `tmp_doc/documents/distributed_DP/05_Decode端拉取KV_Cache.md`
8. `tmp_doc/documents/distributed_DP/06_Prefill端延迟释放与完成确认.md`
9. `tmp_doc/documents/distributed_DP/08_Layerwise_Push模式.md`
10. `tmp_doc/documents/distributed_DP/09_全链路串联总结.md`
