...
- [x] Q001：vLLM 的核心定位是什么？它主要解决 LLM serving 中哪些问题？
  ...
  - 参考材料：`llm-project/research_workspace/documents/question/vllm_overview.md`，`D:/lzy/project/kv_pool/code/vllm`
...
- [x] Q002：Scheduler 为什么不直接管理所有 Worker，而要中间加一层 Executor？
  ...
  - 来源：用户追问；`llm-project/research_workspace/documents/question/executor_worker_model_runner/executor_worker_model_runner_overview.md:21`
  - 参考材料：`llm-project/research_workspace/documents/question/executor_worker_model_runner/executor_worker_model_runner_overview.md`，`D:/lzy/project/kv_pool/code/vllm`
